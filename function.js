...
// function callCalculate(id){
//     const incomeCall = parseFloat(document.getElementById(id).value) ;
//     return incomeCall;
// }

// function removeCalculate(id){
//     document.getElementById(id).classList.remove('hidden');
//     // return removeeCall;
// }

// function numberTofexd(amaunt){
//  return `${amaunt.toFixed(2)}`
// }

// function calculateHistory(caount,income,totalJog,balanceBiyog){
...
//       <p class"text-sm">Income: ${numberTofexd(income)} </p>
//       <p class"text-sm">Expenses: ${numberTofexd(totalJog) } </p>
//       <p class"text-sm">Balance: ${numberTofexd(balanceBiyog) } </p>
// `
...
// const income = callCalculate('income');
// console.log(income)

// if(isNaN(income) || income < 0){
// //   document.getElementById('income-error').classList.remove('hidden');
//   removeCalculate('income-error');
//   return;
// }
// // const software = parseFloat(document.getElementById('software').value);
// const software = callCalculate('software');
// console.log(software)

// if(isNaN(software) || software < 0){
//     // document.getElementById('software-error').classList.remove('hidden');
//     removeCalculate('software-error');
//     return;
//   }
// // const courses = parseFloat(document.getElementById('courses').value);
// const courses = callCalculate('courses');
// console.log(courses)

// if(isNaN(courses) || courses < 0){
//     // document.getElementById('courses-error').classList.remove('hidden');
//     removeCalculate('courses-error');
//     return;
//   }
// // const internet = parseFloat(document.getElementById('internet').value);
// const internet = callCalculate('internet');
// console.log(internet)

// if(isNaN(internet) || internet < 0){
//     // document.getElementById('internet-error').classList.remove('hidden');
//     removeCalculate('internet-error');
//     return;
//   }
...
// // const historyList = document.getElementById('history-list');
// // historyList.insertBefore(eliment, historyList.firstChild);
// calculateHistory(caount,income,totalJog,balanceBiyog)
